...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "pazeto_iot" because\n';
  ...
  $wnd.__gwt_activeModules['pazeto_iot'] = {
    'moduleName' : 'pazeto_iot',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/pazeto_iot.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['pazeto_iot'].superdevmode = true;

  var expectedSuffix = '/pazeto_iot.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + pazeto_iot + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:pazeto_iot';
  var devModeSessionKey = '__gwtDevModeSession:pazeto_iot';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/pazeto_iot/pazeto_iot.nocache.js';
  ...
  $wnd.__gwt_activeModules['pazeto_iot'].canRedirect = true;
  $wnd.__gwt_activeModules['pazeto_iot'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/pazeto_iot?user.agent=' + ua + '&_callback=' + callback;
